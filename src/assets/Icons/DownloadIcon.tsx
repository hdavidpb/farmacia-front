  ...
  return (
    ...
    >
      ...
      <g transform="translate(0.499)">
        ...
        />
        <g transform="translate(14.298 13.839)">
          <path
            className="b"
            d="M383.016,463.1H365.929a2.477,2.477,0,0,1-2.7-2.69q0-4.809,0-9.618a2.475,2.475,0,0,1,4.061-1.935,2.222,2.222,0,0,1,.851,1.577c.039.452.028.908.029,1.363q0,2.95,0,5.9c0,.464,0,.465.452.465h25.886c.978,0,1.955-.011,2.933.007.293.006.383-.062.381-.372q-.021-3.513,0-7.025a2.462,2.462,0,0,1,3.476-2.278,2.322,2.322,0,0,1,1.467,2.2q.039,4.962,0,9.924a2.439,2.439,0,0,1-2.562,2.481Q391.611,463.1,383.016,463.1Z"
            transform="translate(-363.231 -423.554)"
          />
          <path
            className="b"
            ...
            transform="translate(-396.654 -312.186)"
          />
        </g>
      </g>
    </svg>
